...
### 뉴스 요약
대화형 생성 인공지능 챗 GTP의 오픈 AI CEO 샘 알트만이 인공지능 기술이 우리 사회를 재구성하게 될것이라 밝힘, 그러나 기술의 성공에도 불구하고 AI의 위험성을 인정함
악의적으로 활용되거나 환각 문제가 발생할 수있다고 경고함. 다만, 인간의 창의성을 통해 새로운 직업을 찾을 수 있다고 믿으며, AI를 도구로 활용하는 것이 중요하다고 강조함

### 느낀점
AI 위험성은 여러 전문가들이 일전에도 제기했던 문제이다. 나는 완벽한 해결방법은 존재하지 않는다고 생각한다. 때문에 AI를 다루는 사람들의 적절한 윤리의식이 필요하며, 인류 차원에서는 적절한 규제나 법안들이 필요할 것으로 보인다.

---
### 허지은

### 뉴스요약
챗 GPT의 오픈 AI CEO 샘 알트만이 인공지능 기술이 우리 사회를 재구성하게 될것이라 밝힘, 
